...
```
$ docker exec -ti prometheus_apache_log_alerts_fluent_alerter_1 sh

tail -n 1 /fluentd/log/*
...
or
```
$ docker exec -ti prometheus_apache_log_alerts_fluent_alerter_1 ls -l /fluentd/log/
```
